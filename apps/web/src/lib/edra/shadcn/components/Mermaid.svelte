<!--
Adaptação OpenBible (ver `src/lib/edra/README.md`): `mermaid` via `import()`
dinâmico para não pesar o bundle de quem nunca usa diagrama. Tema lido da
classe `dark` do documento.
-->
<script lang="ts">
