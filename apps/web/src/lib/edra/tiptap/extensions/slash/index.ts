...
const GROUPS: Group[] = [
	...
	},
	{
		...
		actions: [
			...
			// Adaptação OpenBible (ver `src/lib/edra/README.md`): abre o
			// seletor de versículos do app, que insere o fence `:::verse`
			// na posição do cursor.
			{
				...
				tooltip: 'Versículo',
				onClick: () => {
					window.dispatchEvent(new CustomEvent('openbible:insert-verse'));
				}
			}
		]
	}
